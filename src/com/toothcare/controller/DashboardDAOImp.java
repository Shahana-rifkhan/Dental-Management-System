...
import com.toothcare.db.ToothcareDb;
import com.toothcare.model.Dashboard;
...
public class DashboardDAOImp implements DashboardDAO {
    ...
    // Assume that you have a method to establish a database connection (e.g., ToothcareDb.getConnection())
    ...
    public int getTotalDoctors() {
        ...
        try (Connection con = ToothcareDb.getConnection();
